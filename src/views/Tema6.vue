...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p En la cadena de suministro, los proveedores juegan un papel muy importante para asegurar el éxito de su negocio, dependiendo de la calidad de sus productos y servicios, y por supuesto, del éxito de su negocio, desempeño de sus productos y servicios. La evaluación es, por tanto, un asunto muy importante y debe realizarse con los parámetros que mejor se adapten a sus necesidades, pero los costos asociados a esta gestión no deben pasarse por alto. 
    p La empresa debe realizar una evaluación del proveedor de forma continua para asegurarse de que no se desvíe del objetivo del cliente. Como resultado, hay una serie de herramientas que puede considerar utilizando los parámetros adecuados para sus necesidades comerciales. Por ejemplo, tiempo de respuesta, costos del servicio, calidad del producto, innovación, etc.

    separador
    #t_6_1.titulo-segundo.color-acento-botones(data-aos="fade-right")
      h2 6.1 Certificación y evaluación de proveedores
    
    p.mb-5 Las empresas y organizaciones de todo el mundo, deben tener todo su sistema de calidad con base en las normas ISO.
    ...
    p.mb-5 Es una norma internacional que toma en cuenta las actividades de una organización, sin distinción de sector de actividad. Esta norma se concentra en la #[strong satisfacción del cliente] y en la #[strong capacidad de proveer productos] y servicios que cumplan con las exigencias internas y externas de la organización.
    ...
    p Es un proceso continuo para comparar el producto, servicio o flujo de trabajo de una gran empresa con su producto, servicio o flujo de trabajo.
    ...
    p #[em Benchmarking] #[strong NO] es:
    ...
    p.mb-5 Estas son las 10 C's del modelo de Carter: 
